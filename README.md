...
#### Termux build dependencies
First enable the x11 repository, then install the dependencies:
```
pkg install x11-repo
pkg install git cmake extra-cmake-modules gettext \
  qt6-qtbase qt6-qtbase-gtk-platformtheme qt6-qtsvg \
  qt6-qtdeclarative kf6-kcoreaddons kf6-kcolorscheme \
  kf6-kconfig kf6-kguiaddons kf6-ki18n kf6-kiconthemes \
  kf6-kwindowsystem kf6-kcmutils kf6-kirigami \
  kdecoration libglvnd-dev xorgproto
```

### Step 2: Then download, build and install
Download, build and install from source script:
```
git clone https://github.com/GeneralKaos666/klassy-for-termux
```

```
cd klassy-for-termux
```
